...
import br.com.fenrir.auth.adapters.entrypoint.boundary.factory.implementations.EmailBoundaryFactoryImpl;
...
import br.com.fenrir.auth.adapters.entrypoint.controller.RegisterController;
import br.com.fenrir.auth.adapters.entrypoint.constants.MvObjectConstants;
//import br.com.fenrir.auth.event.OnSendMailEvent;
...
@Slf4j
@Controller
public class RegisterMvcController implements RegisterController {
    ...
    public ModelAndView processRegistrationForm(ModelAndView modelAndView, @Valid UserBoundaryMapper user,
        ...
        try {
            ...
            accountUseCase.registerUserByEmail(user.getEmail());
    ...
    public ModelAndView processConfirmationForm(ModelAndView modelAndView,
        ...
        try {
            accountUseCase.confirmUserByEmail(token, password);
