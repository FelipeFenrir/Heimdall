...
public interface CredentialsController {
     ...
     */
    ModelAndView showForgottenPasswordPage(ModelAndView modelAndView, UserBoundaryMapper user);
     ...
     * @return {@link ModelAndView} object.
     */
    ModelAndView processForgottenPasswordForm(ModelAndView modelAndView, UserBoundaryMapper user, Locale locale);
