 ...
 */
public interface IEmailDto extends Serializable {
    ...
    /**
     * <p>
     *     Get {@link IEmailContentDto} object with all variables of Mail Content.
     * </p>
     * @return {@link IEmailContentDto} object.
     */
    IEmailContentDto getEmailContent();
}
