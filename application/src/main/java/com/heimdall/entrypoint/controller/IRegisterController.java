...
package com.heimdall.entrypoint.controller;
...
public interface IRegisterController {
     ...
     */
    ModelAndView showRegistrationPage(ModelAndView modelAndView, UserDto user);
     ...
     * @return {@link ModelAndView} object.
     */
    ModelAndView processRegistrationForm(ModelAndView modelAndView, @Valid UserDto user, Locale locale);
