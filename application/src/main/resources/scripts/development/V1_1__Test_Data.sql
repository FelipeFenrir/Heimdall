...
INSERT INTO oauth_client_details (client_id, resource_ids, client_secret, scope, authorized_grant_types, web_server_redirect_uri, authorities, access_token_validity, refresh_token_validity, additional_information, autoapprove) VALUES
	    ('USER_CLIENT_APP', 'AUTH_RESOURCE,CORE_RESOURCE,EMAIL_RESOURCE,ADDRESS_RESOURCE', '{bcrypt}$2a$10$EOs8VROb14e7ZnydvXECA.4LoIhPOoFHKvVF/iBZ/ker17Eocz4Vi', 'ROLE_MASTER,ROLE_ADMIN,ROLE_USER', 'authorization_code,refresh_token,implicit,password,client_credentials', null, 'ROLE_MASTER,ROLE_ADMIN,ROLE_USER', 3600, 2592000, '{}', null);
INSERT INTO oauth_client_details (client_id, resource_ids, client_secret, scope, authorized_grant_types, web_server_redirect_uri, authorities, access_token_validity, refresh_token_validity, additional_information, autoapprove) VALUES
	    ('THIRD_PARTY_APP', 'AUTH_RESOURCE,CORE_RESOURCE,EMAIL_RESOURCE,ADDRESS_RESOURCE', '{bcrypt}$2a$10$EOs8VROb14e7ZnydvXECA.4LoIhPOoFHKvVF/iBZ/ker17Eocz4Vi', 'ROLE_USER', 'authorization_code,refresh_token,password,client_credentials', null, 'ROLE_USER', 3600, 2592000, '{}', null);
INSERT INTO oauth_client_details (client_id, resource_ids, client_secret, scope, authorized_grant_types, web_server_redirect_uri, authorities, access_token_validity, refresh_token_validity, additional_information, autoapprove) VALUES
	    ('SWAGGER_CLIENT_APP', 'AUTH_RESOURCE,CORE_RESOURCE,EMAIL_RESOURCE,ADDRESS_RESOURCE', '{bcrypt}$2a$10$EOs8VROb14e7ZnydvXECA.4LoIhPOoFHKvVF/iBZ/ker17Eocz4Vi', 'ROLE_MASTER,ROLE_ADMIN,ROLE_USER,ROLE_SWAGGER', 'authorization_code,refresh_token,implicit,password,client_credentials', null, 'ROLE_MASTER,ROLE_ADMIN,ROLE_USER,ROLE_SWAGGER', 3600, 2592000, '{}', null);
